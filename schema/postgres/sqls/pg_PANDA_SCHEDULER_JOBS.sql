...
LANGUAGE PLPGSQL
;
ALTER PROCEDURE doma_panda.grant_privs4exist_obj (owner_name text ) OWNER TO panda;
...
CREATE OR REPLACE PROCEDURE doma_panda.update_run_jumbo_count () AS $body$
BEGIN
