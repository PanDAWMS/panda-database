...
CREATE INDEX jobs_destinationdblock_idx ON jobsarchived USING gin(destinationdblock);
...
CREATE INDEX jobs_proddblock_idx ON jobsarchived USING gin(proddblock);
