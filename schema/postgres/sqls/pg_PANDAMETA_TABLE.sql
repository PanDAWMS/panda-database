...
CREATE TABLE cloudconfig (
	...
	moduser varchar(30),
	modtime timestamp NOT NULL DEFAULT statement_timestamp(),
...
CREATE TABLE schedconfig (
	...
	tags varchar(200),
	cmd varchar(200),
	lastmod timestamp NOT NULL DEFAULT statement_timestamp(),
	errinfo varchar(80),
...
CREATE TABLE schedinstance (
	...
	tvalid timestamp NOT NULL DEFAULT statement_timestamp(),
