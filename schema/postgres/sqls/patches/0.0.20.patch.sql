...
-- Update versions
UPDATE doma_panda.pandadb_version SET major=0, minor=0, patch=20 where component='JEDI';
UPDATE doma_panda.pandadb_version SET major=0, minor=0, patch=20 where component='SERVER';
COMMIT;
