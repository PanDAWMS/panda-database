...
CREATE SEQUENCE jedi_data_carousel_request_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1;
ALTER SEQUENCE jedi_data_carousel_request_id_seq OWNER TO panda;
CREATE SEQUENCE IF NOT EXISTS doma_panda.workflow_id_seq INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 1 NO CYCLE;
ALTER SEQUENCE doma_panda.workflow_id_seq OWNER TO panda;
CREATE SEQUENCE IF NOT EXISTS doma_panda.workflow_step_id_seq INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 1 NO CYCLE;
ALTER SEQUENCE doma_panda.workflow_step_id_seq OWNER TO panda;
CREATE SEQUENCE IF NOT EXISTS doma_panda.workflow_data_id_seq INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 1 NO CYCLE;
